...
anno_file = r"C:\Users\Laptop K1\Downloads\etos-mtcnn-master\prepare_data\wider_face_train.txt"
im_dir = r"C:\Users\data_\WIDER_train/images/"
pos_save_dir = r"C:\Users\data_/12/positive"
part_save_dir = r"C:\Users\\data_/12/part"
neg_save_dir = r"C:\Users\data_/12/negative"
save_dir = r"C:\Users\data_/12"
...
for annotation in annotations:
    ...
    #load image
    pth = os.path.join(im_dir, im_path+'.jpg' )
    print(pth)
    img = cv2.imread(pth)
    idx += 1
    #if idx % 100 == 0:
    ...
    while neg_num < 50:
        ...
        if np.max(Iou) < 0.3:
            ...
            f2.write(r"C:\Users/data_/12/negative/%s.jpg"%n_idx + ' 0\n')
    ...
    for box in boxes:
        ...
        for i in range(20):
            ...
            if iou  >= 0.65:
                ...
                f1.write(r"C:\Users/data_/12/positive/%s.jpg"%p_idx + ' 1 %.2f %.2f %.2f %.2f\n'%(offset_x1, offset_y1, offset_x2, offset_y2))
                cv2.imwrite(save_file, resized_im)
                p_idx += 1
            elif iou >= 0.4:
                save_file = os.path.join(part_save_dir, "%s.jpg"%d_idx)
                f3.write(r"C:\Users/data_/12/part/%s.jpg"%d_idx + ' -1 %.2f %.2f %.2f %.2f\n'%(offset_x1, offset_y1, offset_x2, offset_y2))
                cv2.imwrite(save_file, resized_im)
                d_idx += 1
        box_idx += 1
        if idx % 100 == 0:
