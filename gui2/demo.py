...
import load_model
class WebcamApp:
    def __init__(self, window, window_title,model_path, video_source=0,threshold=0.7):
        # self.model_path = r'D:\20231\code\deep learning\project\pre train model\new world\firstbigtrain.pth'  
        self.threshold=threshold
        self.window = window
        self.window.title(window_title)
        self.model=load_model.LoadBestModel(model_path)
...
if __name__=='__main__':
    ...
    model_path=r'load/finetune_MobileNetV3_epoch_63_10000.pth'
    root = tk.Tk()
    app = WebcamApp(root, "Face Identification App",model_path=model_path,threshold=0.7)
