import sys
import os
sys.path.append(os.path.join(os.path.abspath(os.path.pardir),"/prepare_data"))
sys.path.append(os.path.join(os.path.abspath(os.path.pardir),"/train_models"))
...
image = cv2.imread(r'C:\Users\Laptop K1\Downloads\413297565_1618023642352483_1633249659324767297_n.jpg')
