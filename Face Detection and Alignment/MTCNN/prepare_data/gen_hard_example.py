...
import cv2
sys.path.append(os.path.join(os.path.abspath(os.path.pardir),"etos-mtcnn-master"))
print(sys.path)
...
#net : 24(RNet)/48(ONet)
#data: dict()
def save_hard_example(net, data,detections):
    ...
    # save files
    neg_label_file = r"C:/Users/data_/no_LM%d/neg_%d.txt" % (net, image_size)
    neg_file = open(neg_label_file, 'w')

    pos_label_file = r"C:/Users/data_/no_LM%d/pos_%d.txt" % (net, image_size)
    pos_file = open(pos_label_file, 'w')

    part_label_file = r"C:/Users/data_/no_LM%d/part_%d.txt" % (net, image_size)
    part_file = open(part_label_file, 'w')
    assert len(detections) == num_of_images, "Incorrect detections or ground truths"
    ...
    for im_idx, dets, gts in zip(im_idx_list, detections, gt_boxes_list):
...
def t_net(prefix, epoch,
    ...
    basedir = r'C:/Users/data_/'
    #anno_file
    filename = r'C:\Users\Laptop K1\Downloads\etos-mtcnn-master\prepare_data\wider_face_train_bbx_gt.txt'
    ...
    if not os.path.exists(save_path):
        os.mkdir(save_path)
    save_hard_example(image_size, data,detections)
...
def parse_args():
    ...
    parser.add_argument('--prefix', dest='prefix', help='prefix of model name', nargs="+",
                        default=[r'C:/Users/data_/MTCNN_model/PNet_Landmark/PNet', r'C:/Users/data_/MTCNN_model/RNet_Landmark/RNet', r'C:/Users/data_/MTCNN_model/ONet_No_Landmark/ONet'],
                        type=str)
...
if __name__ == '__main__':
    ...
    base_dir = r'C:/Users/data_/WIDER_train'
    data_dir = r'C:/Users/data_/no_LM%s' % str(image_size)
